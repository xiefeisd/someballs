    ...
    removeBall(key){
      ...
      this.initializeBalls();
		...
		setParametersForShow(){
			...
			//轨道偏移
			var showOrbitRadiusOffset = 0.2 - Math.log10(minPosition) ;
			//球径偏移
			var showBallRadiusOffset = 1 - Math.log10(minRadius) ;
			//轨道倍率
			var showOrbitRadiusRatio = 0.9 * this.canvasSize / 2 / ( Math.log10(maxPosition) + showOrbitRadiusOffset ); 
			//球径倍率
			var showBallRadiusRatio =  0.01 * this.canvasSize / ( Math.log10(maxRadius) + showBallRadiusOffset ); 
